...
class Molecule(Chem.Mol):
    ...
    def get_scores_from_similarity_file(self):
        """
        ...
        :return: None
        """
        with open('similarity_hits.txt', 'r') as similarity_hits:
    ...
    def print_output_file(self, filename=None):
        ...
        filename = f'{self.name}_output.csv' if filename is None else filename
